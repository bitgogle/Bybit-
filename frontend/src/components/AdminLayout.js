...
export default function AdminLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-white flex">
      {/* Sidebar - Blue Theme */}
      <aside className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-blue-900/70 backdrop-blur-md border-r border-blue-800 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300`}>
